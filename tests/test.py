from ..src import investment_module
...
annual_expense = 0 # 181000  # Adjust this value as needed
...
balance_with_expenses = investment_module.calculate_balance(retirement_balance, interest_rate, years, annual_surplus=annual_surplus, gains=gains, expenses=expenses, annual_expense=annual_expense)
